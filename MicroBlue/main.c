...
volatile uint8_t threshholds[10] = {1000,1000,1000,1000,1000,1000,1000,1000,1000,1000};
...
void printDiffs() {
    ...
    printf("***************************************\n");
    for (i = 0; i < 4\10; i++) {
        printf("%d: %d\n",i,abs(CupPrevious[i] - CupCurrent[i]));
    }
